...
"""
This is the REDIS protocol we will use to read binary data over the wire

Data Types:      Prefix    Structure                            Example
...
class ProtocolHandler(object):
    ...
    def handle_request(self, socket_file):
        ...
        try:
            # delegate to the proper handler based on the first byte
...
class Server(object):
    ...
    def get_response(self, data):
        # unpack data sent by client, execute their command, and send a response
        # we see if the data received is a string, if so, we want to break it down into a list by splitting at whitespace
